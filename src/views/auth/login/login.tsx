...
const Login = () => {
  ...
  return (
    <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
      <div className="flex flex-wrap items-center justify-center border">
          ...
          <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <AppInput
                ...
                onChange={handleChange}
                error={passwordError}
                icon={<Iconify icon="material-symbols:lock-open-rounded" />}
                toggleIcon={<Iconify icon="mdi:password" />}
              />
            ...
            <button className="flex w-full items-center justify-center gap-3.5 rounded-lg border border-stroke bg-gray p-4 hover:bg-opacity-50 dark:border-strokedark dark:bg-meta-4 dark:hover:bg-opacity-50">
              ...
              <div className="mt-6 text-center">
                <p>Don’t have any account? Please Contact Your Orginization</p>
              </div>
            </form>
          </div>
        </div>
